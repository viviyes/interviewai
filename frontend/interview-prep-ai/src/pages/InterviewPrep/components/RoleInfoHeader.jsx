...
const RoleInfoHeader = ({
  ...
  return <div className="bg-[#fcfbfc] relative">
      <div className="container mx-auto px-10 md:px-0">
        ...
        <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-[#fcfbfc] overflow-hidden absolute top-0 right-0">
